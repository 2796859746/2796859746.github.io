  ...
  ;(r.prototype.getSuffix = function (t, i) {
        ...
        if (null === e) {
          ...
          this.isValidCaption(s) || (s = t.attr('title')),
            this.isValidCaption(s) &&
              ((e = g('<div class="caption">' + s + '</div>')), t.append(e), t.data('jg.createdCaption', !0))
        }
        null !== e &&
          (this.settings.cssAnimation || e.stop().fadeTo(0, this.settings.captionSettings.nonVisibleOpacity),
    ...
    (r.prototype.onEntryMouseEnterForCaption = function (t) {
      ...
      this.settings.cssAnimation
        ...
        : i.stop().fadeTo(this.settings.captionSettings.animationDuration, this.settings.captionSettings.visibleOpacity)
    }),
    (r.prototype.onEntryMouseLeaveForCaption = function (t) {
      ...
      this.settings.cssAnimation
        ...
        : i
            .stop()
            .fadeTo(this.settings.captionSettings.animationDuration, this.settings.captionSettings.nonVisibleOpacity)
    }),
  ...
  ;(r.prototype.rememberGalleryHeight = function () {
          ...
          if (this.$gallery.is(':visible')) {
            ...
            e() === this.scrollBarOn
              ? Math.abs(t - this.galleryWidth) > this.settings.refreshSensitivity &&
                ((this.galleryWidth = t), this.rewind(), this.rememberGalleryHeight(), this.startImgAnalyzer(!0))
    ...
    (r.prototype.stopImgAnalyzerStarter = function () {
      ;(this.yield.flushed = 0),
        null !== this.imgAnalyzerTimeout && (clearTimeout(this.imgAnalyzerTimeout), (this.imgAnalyzerTimeout = null))
    }),
